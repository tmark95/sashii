...
<body>
  ...
  <h1> Bebidas</h1>
      ...
      <h3 class="titulo">Agua mineral 500cc </h3>
			<p>$50</p>
			<button type="button" name="Añadir al carrito">Añadir al carrito</button>

      <h3 class="titulo">Gaseosa Linea PEPSI 500cc</h3>
			<p>$60</p>
			<button type="button" name="Añadir al carrito">Añadir al carrito</button>

      <h3 class="titulo">Agua saborizada 500cc</h3>
			<p>$60</p>
			<button type="button" name="Añadir al carrito">Añadir al carrito</button>

      <h3 class="titulo">Cerveza Imperial 1l</h3>
			<p>$110</p>
			<button type="button" name="Añadir al carrito">Añadir al carrito</button>
